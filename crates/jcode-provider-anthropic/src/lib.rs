...
/// prompt blocks.
pub const OAUTH_BILLING_HEADER: &str = "cc_version=2.1.259; cc_entrypoint=sdk-cli; cch=33f85;";
...
pub fn format_messages(messages: &[Message], is_oauth: bool) -> Vec<ApiMessage> {
    ...
    // blaude never intends to prefill, so a trailing assistant turn here is always
