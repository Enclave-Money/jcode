...
//! low-level keyboard hook in the first-party Rust listener (`blaude setup-hotkey
...
/// Translate a canonical blaude key token into a Win32 virtual-key code.
...
pub(crate) fn render_windows_listener_ps1(
    ...
    Some(format!(
        r#"# blaude global launch hotkey listener
# Auto-generated by blaude setup-hotkey from [launch_hotkeys] config. Runs at
# login via a startup shortcut. Do not edit; re-run `blaude setup-hotkey`.
...
mod tests {
    ...
    fn listener_script_registers_each_entry_and_dispatches_dirs() {
        let entries = vec![
            hk("win+shift+f23", "C:\\Users\\u\\blaude", "jcode", false),
        ...
        assert!(script.contains("Resolve-JcodeFixedDir 'C:\\Users\\u\\blaude'"));
