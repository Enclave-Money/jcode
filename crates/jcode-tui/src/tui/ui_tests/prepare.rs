    ...
    let state = TestState {
        ...
        batch_progress: Some(crate::bus::BatchProgress {
            ...
            running: vec![ToolCall {
                ...
                name: "bash".to_string(),
                input: serde_json::json!({
                    "command": "cargo test --package blaude --lib tui::ui::tests::render_tool_message_batch_rows_do_not_soft_wrap_on_narrow_width -- --nocapture --exact with-extra-flags-and-output-to-stretch-the-line"
                }),
                intent: None,
                thought_signature: None,
            }],
