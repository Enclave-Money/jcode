...
//!
//! 1. **Rare-hotkey feedback.** When the user presses a chord blaude recognizes
...
/// A chord blaude responds to, with a human description of what it does.
#[derive(Debug, Clone)]
...
/// Resolve what a chord does, or `None` when blaude has no binding for it.
pub(super) fn lookup(
