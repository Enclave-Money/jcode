        ...
        append_batch_progress_spans(
            ...
            Some(crate::bus::BatchProgress {
                ...
                running: vec![crate::message::ToolCall {
                    ...
                    name: "bash".to_string(),
                    input: serde_json::json!({"command": "cargo test -p blaude"}),
                    intent: None,
...
pub(super) fn draw_input(
    ...
    let area = if area.height >= 4 && area.width >= 8 {
        ...
        let mode_style = match mode {
            ...
            crate::tui::WorkMode::Plan => Style::default().fg(rgb(86, 197, 184)),
            crate::tui::WorkMode::Ask => Style::default().fg(rgb(120, 180, 255)),
            crate::tui::WorkMode::Manual => Style::default().fg(rgb(210, 210, 215)),
        };
