...
/// bare id blaude uses for routing and coverage keys.
///
...
/// blaude re-emits as text deltas, so we assert the runtime produced streamed
...
///
/// Some native runtimes deliver a single coalesced response that blaude re-emits
